...
namespace Manga_Rica_P1.Entity
{
    ...
    public class Hora
    {
        ...
        [Column("Id_Usuario")]
        [Required(ErrorMessage ="El campo Id_Usuarios es necesario")]
        ...
        /// <summary>
        /// Registra la salida, calcula Total_Horas y valida que sea razonable.
        /// </summary>
        public void CerrarJornada(DateTime horaSalida, double maxHoras = 15)
        {
            ...
            Total_Horas = Math.Round(horas, 2);
        }
