...
{
    partial class FormReporteSodaPorEmpleado
    {
        ...
        private EmpleadoFechaFiltroSidebar filtroEmpleadoFechas;
        ...
        private void InitializeComponent()
        {
            ...
            panelSidebar.Controls.Add(filtroEmpleadoFechas);
            ...
            // 
            // filtroEmpleadoFechas
            // 
            filtroEmpleadoFechas.BackColor = SystemColors.Control;
            filtroEmpleadoFechas.CarneTexto = "";
            filtroEmpleadoFechas.Dock = DockStyle.Top;
            filtroEmpleadoFechas.FechaDesde = new DateTime(2025, 12, 1, 0, 0, 0, 0);
            filtroEmpleadoFechas.FechaHasta = new DateTime(2025, 12, 1, 0, 0, 0, 0);
            filtroEmpleadoFechas.Location = new Point(0, 8);
            filtroEmpleadoFechas.Name = "filtroEmpleadoFechas";
            filtroEmpleadoFechas.Size = new Size(200, 220);
            filtroEmpleadoFechas.TabIndex = 0;
            // 
            // panelTop
            // 
            ...
            lblHint.TabIndex = 2;
            lblHint.Text = "Seleccione un carné y un rango de fechas en el panel izquierdo y presione \"Generar reporte\".";
            // 
            // webView
            // 
